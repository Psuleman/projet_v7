...
/**
 * @extends ServiceEntityRepository<CategorieUnivers>
 *
...
class CategorieUniversRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(CategorieUnivers $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(CategorieUnivers $entity, bool $flush = true): void
    {
