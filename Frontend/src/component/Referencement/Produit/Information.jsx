...
const Information = () => {
    ...
    const {marqueUpdate, setMarqueUpdate, prixVenteRemiseUpdate, setPrixVenteRemiseUpdate, universUpdate, setUniversUpdate, universEnUpdate, setUniversEnUpdate} = useContext(ProduitContext)
            ...
            <div>
                {
                    tabImage && 
                    <div>
                        <src src={tabImage[0]} alt="image"/>
                        <a href={tabImage[0]}>Images</a>
                    </div>
                }
            </div>
