...
const Description = () => {
	...
	const {dimensionFrUpdate, dimensionEnUpdate, coupeUpdate,	entretienUpdate,  descriptionFrUpdate, 	descriptionEnUpdate, nomProduitFrUpdate, nomProduitEnUpdate, tailleMannequinUpdate} = useContext(ProduitContext)
	const {setDimensionFrUpdate, setDimensionEnUpdate, setCoupeUpdate, setEntretienUpdate, setDescriptionFrUpdate, setDescriptionEnUpdate, setNomProduitFrUpdate, setNomProduitEnUpdate, setTailleMannequinUpdate} = useContext(ProduitContext)
        ...
        return (
        	<div className="description">
				...
				<TemplateInputSelect label="TAILLE PORTÉE PAR LE MANNEQUIN" typeInput="text" valeurUpdate={produit.taillePorteeMannequin} attributUpdate={tailleMannequinUpdate} setAttributUpdate={setTailleMannequinUpdate} urlAPI="http://212.129.3.31:8080/api/tailles" />
